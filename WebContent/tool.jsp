...
<meta content="width=device-width,initial-scale=1" name="viewport">
    ...
    <link rel="stylesheet" href="telerik/styles/kendo.default.min.css" />
...
<li class="wd-Navigation-node">
<a class="wd-Navigation-link is-active" href="/NLPLWebTool/tool.jsp">Using Tool</a>
<br/>
<jsp:include page='filebrowse.jsp'>
...
<div class="wd-l-Content isu-content" id="content" role="main">
	<div class="wd-l-Content-inner">
		<jsp:include page='translation.jsp'>
		    <jsp:param name="articleId" value=""/>
		</jsp:include>
	</div>
